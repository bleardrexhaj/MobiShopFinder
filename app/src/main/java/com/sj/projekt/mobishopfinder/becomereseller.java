...
public class becomereseller extends AppCompatActivity  implements View.OnClickListener{
    ...
    private EditText user_name,user_surname,shop_name,shop_city,shop_email,user_password,user_confirm_password;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.register_button :
                ...
                if(!user_name.getText().toString().equals("") && !user_surname.getText().toString().equals("") && !user_password.getText().toString().equals("")&& !user_confirm_password.getText().toString().equals("")&& !shop_email.getText().toString().equals("")&& !shop_city.getText().toString().equals("")&& !shop_name.getText().toString().equals("")&& !shop_location.getText().toString().equals("")) {
                    ...
                    String qyteti_mobileshopit = shop_city.getText().toString();
